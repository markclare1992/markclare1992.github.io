...
### Origin
With a large dataset it is fairly easy to compute a quick estimate for how much a penalty is worth.  Looking at the outcome of penalties awarded (excluding penalty shootouts) we can see where the widely used figure of 0.76 comes from.
