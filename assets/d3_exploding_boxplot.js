...
function(d3,d3tip)
{
  ...
  var default_colors = ["#468CDE","#52D273","#E94F64","#E57254","#E5C454","#D6DBDE","#656565"]
  ...
  var exploding_boxplot = function(data,aes)
  {
    ...
    if(aes.group){
      groups = d3.nest()
                .key(functorkey(aes.group)).sortKeys(d3.ascending)
                .entries(data)
    }else{
      ...
      return o
		...
		var _tipFunction = function(d) {
				return ' <span style="color:'+colorscale(functorkey(aes.color)(d))+'">'+
						functorkey(aes.label_1)(d) + '<br/>'+
						functorkey(aes.label_2)(d) + '<br/>'+ 
						functorkey(aes.label_3)(d) + '<br/>'+
						functorkey(aes.label_4)(d) + '<br/>'+
						functorkey(aes.label_5)(d) + 
